...
**Handling unmatched alleles between baseline and test data.** In some cases, alleles found in test data may not exist in baseline data, or vice versa. The function `assign.X` will check if alleles of a locus are identical between your baseline and test data. If they are different, it will ask you if you want to use the loci in common to continue the analysis. If answer 'yes', the assignment test will ignore the loci that have different alleles between baseline and test data.   
