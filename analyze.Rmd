...
In this page, we demonstrate how to prepare, import, and analyze your data. We describe two resampling cross-validation methods, Monte-Carlo and K-fold cross-validations, which help evaluate the performance of your baseline data. Informative loci also could be identified from the results of cross-validation, if needed. In addition, we include a function that allows users to use a baseline to predict source populations of individuals of unknown origins. 
